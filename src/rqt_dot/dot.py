...
digraph scheme {
  ...
  barrett_manager [shape=record,label="\N|{{<i0>wam.effort_in}| |{<o0>wam.effort_out|<o1>wam.position_out|<o2>wam.velocity_out}}|{{0.0001|205.7}|{0.00112 +/- 1E-7 (85%)|800.4 +/- 3} | {0.002|855.5}}"];
...
class Dot(Plugin):
    ...
    def __init__(self, context):
        ...
        #testing:
        #self._widget.xdot_widget.set_dotcode(ddcode)
